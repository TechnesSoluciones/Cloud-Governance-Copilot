...
const ToastItem: React.FC<ToastItemProps> = ({ toast, onRemove }) => {
  ...
  return (
    <div
      className={`pointer-events-auto flex items-center gap-3 rounded-lg border p-4 shadow-lg transition-all duration-200 ${variants[toast.variant]}`}
      role="alert"
    >
      {icons[toast.variant]}
...
export const toast = {
  success: (message: string, duration?: number) => {
    // This will be replaced by the context hook
